...
function lookupErrors(i) {
    return i.errs.map(function (e) { return mkError(i.file, e); });
}
...
var Annotations = (function () {
    ...
    Annotations.prototype.rebuild = function (sFile, sTime) {
        var _this = this;
        ...
        return modifiedAt(jFile)
            ...
            _this.fileMap[sFile] = fi;
            exports.debugLiquidUtils = fi;
            return fi;
        });
    };
    Annotations.prototype.refresh = function (sFile) {
        ...
        return modifiedAt(sFile)
            ...
            return _this.rebuild(sFile, sTime);
        });
    };
